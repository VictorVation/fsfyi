...
export default async function HomePage() {
  ...
  return (
    <div className="max-w-screen-xl grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
      <div className="mx-auto max-w-lg text-center lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
        ...
        <p className="mt-4 text-gray-600">
          FlightSchool.fyi is your ticket to the skies! We offer everything you
          need to know about flight schools, from ratings and reviews to
